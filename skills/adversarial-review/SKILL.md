...
You are the orchestrator, not any of these roles. Do not review the diff yourself in the main context — you likely carry the implementer's framing already. Delegate the reviewing to fresh subagents so the split is real.
